...
extern ScriptCompilerCachedData *
UnboundScriptCreateCodeCache(IsolatePtr iso_ptr, UnboundScriptPtr us_ptr);
extern void
ScriptCompilerCachedDataDelete(ScriptCompilerCachedData *cached_data);
...
extern int TemplateSetAnyValue(TemplatePtr ptr, ValuePtr key, ValuePtr val_ptr,
                               int attributes);
extern void TemplateSetTemplate(TemplatePtr ptr, const char *name,
                                TemplatePtr obj_ptr, int attributes);
extern int TemplateSetAnyTemplate(TemplatePtr ptr, ValuePtr key,
                                  TemplatePtr obj_ptr, int attributes);
...
extern void ObjectTemplateSetAccessorProperty(TemplatePtr ptr, const char *key,
...
extern ValuePtr NewValueError(IsolatePtr iso_ptr, ErrorTypeIndex idx,
                              const char *message);
